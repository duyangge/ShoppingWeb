  ...
  <div class="admin-content">
    ...
    <div class="am-g" style="margin-left:400px;" align="left">
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" id="updateUserInfo" action="${pageContext.request.contextPath }/user_updateUserByUser.action" method="post">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">姓名 / Name</label>
            <div class="am-u-sm-9">
              <input type="text" id="user-name" placeholder="姓名 / Name" name="username" value="${user.username }" maxlength="11">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="email" id="user-email" placeholder="输入你的电子邮件 / Email" name="mail" value="${user.mail }">
              <small>邮箱你懂得...</small>
           ...
           <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="password" id="user-pw" placeholder="输入你的密码 / Password" name="password" value="${user.password }">
               <div align="right"><font id="alterpw" color="red"></font></div>
            </div>
          </div>
          
           <div class="am-form-group">
            <label for="user-phone" class="am-u-sm-3 am-form-label">确认密码 / RePassword</label>
            <div class="am-u-sm-9">
              <input type="password" id="user-repw" placeholder="再输入你的密码 / Password" name="repassword" value="${user.password }">
